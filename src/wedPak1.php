...
<body>
    ...
    <div class="container">
        <div class="package-header">
            <img src="./asset/icons/PKT WD1.png" alt="Paket Catering">
            <div class="package-details">
                <h2>WEDDING PACKAGE I</h2>
                <p>Rp. 15.000.000</p>
        ...
        <div class="description">
            <h3>DETAILS WEDDING PACKAGE I</h3>
        </div>
        <div class="include">
            <h3>INCLUDE:</h3>
            <ul>
                <li>KUDE PELAMINAN STANDAR <span>1 SET</span></li>
                <li>SET KURSI PENGANTIN <span>1 SET</span></li>
                <li>KURSI TAMU PLASTIK + SARUNG <span>500 BUAH</span></li>
                <li>TARUB STANDAR <span>10 UNIT</span></li>
                <li>KARPET <span>10 METER</span></li>
                <li>LIGHTING <span>2 BUAH</span></li>
                <li>BUNGA DEKORASI <span>2 BOX</span></li>
            </ul>
        </div>
    </div>
</body>
