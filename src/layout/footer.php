<footer class="pb-5 w-full">
  <div class="grid grid-cols-3 gap-4 container place-content-center ms-12">
    ...
    <div>
      ...
      <span class="font-semibold">Kemiling Permai, Kec. Kemiling, Kota Bandar Lampung, Lampung 35151</span>
    </div>
    <div>
      ...
      <div class="flex justify-center gap-3">
        ...
        <a href="https://www.instagram.com/gstkdw_?igsh=Znp5NnZzMnI5N282&utm_source=qr" target="_blank">
          <img src="./asset/icons/instagram.png" alt="Instagram" class="icon-small">
        </a>
        <a href="https://youtube.com/@safiraaulia2584?si=a_-ut5eXtf0mVKZf" target="_blank">
          <img src="./asset/icons/youtube.png" alt="Yt" class="icon-small">
        </a>
        <a href="http://wa.me/87899258741" target="_blank">
          <img src="./asset/icons/whatsapp (1).png" alt="wa" class="icon-small">
        </a>
      </div>
    </div>
  </div>
